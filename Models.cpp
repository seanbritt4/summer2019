...
{
    LoadDataToGraphicsCard(vPosition, vColor, vNormal);
    reload = GL_TRUE;
}

/**
\brief Loads the object data to the graphics card assuming that
the positions of the vertices, colors, and normals are 0, 1, and 2
respectively.
...
void Models::LoadDataToGraphicsCard(GLint v, GLint c, GLint n)
{
    vPosition = v;
    vColor = c;
